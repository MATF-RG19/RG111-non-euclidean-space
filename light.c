...
material material_portal  = { { 0.2f, 0.05f, 0.2f, 1 }, { 0.3f, 0.1f, 0.3f, 1 }, { 0.1f, 0.1f, 0.1f, 1 }, 20 };
material material_portal_blue  = { { 0.05f, 0.05f, 0.4f, 1 }, { 0.2f, 0.2f, 0.5f, 1 }, { 0.1f, 0.1f, 0.1f, 1 }, 20 };
material material_portal_orange  = { { 0.4f, 0.2f, 0.1f, 1 }, { 0.6f, 0.2f, 0.1f, 1 }, { 0.1f, 0.1f, 0.1f, 1 }, 20 };
